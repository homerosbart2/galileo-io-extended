var events = [
	...
	},
	{
		...
		description : 'Dialogflow es la herramienta de Natural Language Processing de Google, veremos cómo hacer la integración Messenger.',
...

	{
		...
		{
		name : 'Hacking 101: Técnicas básicas de ataque y defensa',
		description : 'Veremos cuáles son los vectores de ataques comunes hacia los sistemas informáticos, y de qué manera podemos prevenirlos.',
		speaker : 'Jorge Cajas',
		day : '30',
		time : '10:30',
		place : '401 - Torre 1',
	...
	{
		name : 'Building a Custom Machine Learning Model on Android',
		description : 'Aprenderás como crear tu aplicación de Android que puede detectar y etiquetar imágenes con un modelo de Tensorflow Lite en ML Kit for Firebase.',
	...
	{
		name : 'Deep Learning',
		description : 'Aplicaciones de deep learning, el estado del arte y algunos cursos que pueden llevar para que puedan empezar en este tema.',
	...
	{
		name : 'Automatizando el proceso de release de Android con Fastlane',
		description : 'Fastlane permite automatizaar el proceso de prueba y lanzamiento en iOS y Android. Veremos tareas como firmar códidgo, generar capturas y administrar metadatos.',
	...
	{
		name : 'Buenas prácticas en la implementqación de proyectos en Google Cloud Platform',
		description : 'La implementación de buenas prácticas nos permite tener una mejor visibilidad y sacarle el provecho a los recursos disponibles',
